    ...
    return (
        <div className='d-flex flex-wrap justify-content-between container'>
            ...
            <div className='img-hover-zoom'>
                <img className='rounded-3 img-fluid mt-5' src="https://images.unsplash.com/photo-1512433457759-6222e69eade9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&height=420&q=100" alt="" />
            </div>
        </div>
    );
};
